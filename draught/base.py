...
from draught.babel import babel, possible_locales
from draught.flatpages import cf_pages
from draught.utils.ldap_utils import User
...
def init_app():
    ...
    from draught.blueprints import bp_features, bp_pages, bp_documents, bp_news\
        #bp_usersuite, \
    ...
    from draught.utils.database_utils import query_gauge_data
